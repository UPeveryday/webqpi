...
namespace Routines.Api.Data
{
    public class RoutineDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Emloyee>().Property(x => x.EmployeeNo).IsRequired().HasMaxLength(10);
            modelBuilder.Entity<Emloyee>().Property(x => x.FirstName).IsRequired().HasMaxLength(50);
            modelBuilder.Entity<Emloyee>().Property(x => x.LastName).IsRequired().HasMaxLength(50);

            modelBuilder.Entity<Emloyee>().HasOne(x => x.Company).WithMany(x => x.Emloyees)
                .HasForeignKey(x => x.CompanyId).OnDelete(DeleteBehavior.Cascade);//DeleteBehavior.Restrict不允许级联删除
            ...
            modelBuilder.Entity<Emloyee>().HasData(
                 new Emloyee
                 {
